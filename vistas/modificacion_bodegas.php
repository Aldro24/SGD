...
body:not(.modal-open){ padding-right: 0px !important; }
      ...
      <div class="content-wrapper" >        
        ...
        <section class="content" >
          <center><label style="font-size:40px" id="idtitulo">SEGUIMIENTO DE MODIFICACIÓN DE BODEGAS DEL SISTEMA </center></label> 
            <div class="row">
              <div class="col-md-12">
                  <div class="box" >
...
<script type="text/javascript" src="scripts/modificacion_bodegas.js"></script>
