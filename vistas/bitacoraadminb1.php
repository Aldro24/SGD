...
body:not(.modal-open){ padding-right: 0px !important; }
      ...
      <div class="content-wrapper">        
        ...
        <section class="content">
          <center><label style="font-size:40px" id="idtitulo"> BITÁCORA DE LA BODEGA 1 </center></label> 
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover" style="border-color: black;">
                          <thead style="background-color: #337ab7 !important; color: white">
                            ...
                            <th style="text-align: center;">Ultimo usuario en activarlo </th>
                            <th style="text-align: center;">Fecha de ultima activación</th>
                            <th style="text-align: center;">Ultimo usuario en desactivarlo</th>
                            <th style="text-align: center;">Fecha de ultima desactivación</th>
...
<script type="text/javascript" src="scripts/bitacoraadmin.js"></script>
<?php
  }
  ob_end_flush();
?>