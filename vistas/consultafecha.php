                  ...
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros"   >
                      ...
                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <table id="tbllistado" class="table table-striped table-bordered display nowrap"cellspacing="0" style="border-color: black;" width="100%" style>
                          ...
                          <tfoot style="background-color: #337ab7 !important; color: white; display: table-header-group; ">
                            <th style="text-align: center; ">Fecha</th>
