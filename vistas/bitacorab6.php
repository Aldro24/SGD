...
body:not(.modal-open){ padding-right: 0px !important; }
      ...
      <div class="content-wrapper">        
        ...
        <section class="content">
          <center><label style="font-size:40px" id="idtitulo"> BITÁCORA DE BODEGA 6 </center></label> 
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body" style="" height="400px" id="formularioregistros" >
                        <form name="formulario" id="formulario" method="POST" >
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                            ...
                            <input type="date" name="fecha_modificacion" id="fecha_modificacion" class="form-control" maxlength="20" value="<?php echo date("Y-m-d"); ?>" placeholder="" required  >
                          </div>
...
<script type="text/javascript" src="scripts/bitacorab6.js"></script>
<?php
  }
  ob_end_flush();
?>