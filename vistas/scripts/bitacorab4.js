...
function listar()
{
    tabla=$('#tbllistado').dataTable(
    {
        ...
        "ajax":
                {
                    url: '../ajax/bitacorab4.php?op=listarb',
                    type : "get",
                    dataType : "json",                      
                    error: function(e){
...
function guardaryeditar(e)
{
    ...
    $.ajax({
        url: "../ajax/bitacorab4.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
{
    $.post("../ajax/bitacorab4.php?op=mostrar",{id_documento : id_documento}, function(data, status)
    {
...
function desactivar(id_documento)
{
    bootbox.confirm("¿Está Seguro de desactivar esta bitacora?", function(result){
        if(result)
        {
            $.post("../ajax/bitacorab4.php?op=desactivar", {id_documento : id_documento}, function(e){
                bootbox.alert(e);
                tabla.ajax.reload();
            }); 
        }
...
function activar(id_documento)
{
    bootbox.confirm("¿Está Seguro de activar la bitacora?", function(result){
        if(result)
        {
            $.post("../ajax/bitacorab4.php?op=activar", {id_documento : id_documento}, function(e){
                bootbox.alert(e);
                tabla.ajax.reload();
            }); 
        }
