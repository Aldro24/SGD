...
"ajax": 
        {
            url: '../ajax/documento_activoc.php?op=listarb',
            type: "get",
            dataType: "json",
            error: function(e){
...
function guardaryeditar(e)
{
    ...
    $.ajax({
        url: "../ajax/documento_activoc.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
{
$.post("../ajax/documento_activoc.php?op=mostrar",{ id_documento : id_documento}, function(data, status)
...
bootbox.confirm("¿Esta seguro que quiere desactivar el documento?",function(result){
    ...
    if(result)
    {
$.post("../ajax/documento_activoc.php?op=desactivar",{id_documento : id_documento}, function(e)
    {
        bootbox.alert(e);
        tabla.api().ajax.reload();
...
bootbox.confirm("¿Esta seguro que quiere activar el documento?",function(result){
    ...
    if(result)
    {
$.post("../ajax/documento_activoc.php?op=activar",{id_documento : id_documento}, function(e)
    {
        bootbox.alert(e);
        tabla.api().ajax.reload();
