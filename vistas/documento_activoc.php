                        ...
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover" style="border-color: black ">
                          <thead style="background-color: #337ab7 !important; color: white" >
                            ...
                            <th style="text-align: center;">Ultimo usuario que modificó</th>
                              <th style="text-align: center;">Ultima fecha de modificación </th>
                              <th style="text-align: center;">Ultimo usuario que activo</th>
                              <th style="text-align: center;">Ultima fecha de activación </th>
                              <th style="text-align: center;">Ultimo usuario que desactivó</th>
                              <th style="text-align: center;">Fecha que desactivación</th>
                    ...
                    <div class="panel-body" style="" height="300px" id="formularioregistros" >
                        <form name="formulario" id="formulario" method="POST" >
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                            ...
                            <input type="text" class="form-control" name="numero_documento" id="numero_documento" maxlength="100" placeholder="Nombre del documento" required>
                          </div>
                  ...
                  <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select id="fk_bodega_archivo_documento" name="fk_bodega_archivo_documento" class="form-control selectpicker" data-live-search="true" ></select>
                        ...
                        <input type="text" class="form-control" name="cargo_destinatario" id="cargo_destinatario" maxlength="64" placeholder="Cargo del destinatario" required> 
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style="visibility:hidden;">
                            <label></label>
...
<script type="text/javascript" src="scripts/documento_activoc.js"></script>
