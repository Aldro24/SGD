...
switch ($_GET["op"]){
    ...
    case 'listarb':
        $rspta=$documento_activo->listarb();
        ...
        while ($reg=$rspta->fetch_object()){
            $data[]=array(
                ...
                "18"=>$reg->fk_usuario_que_modifico_documento,
                "19"=>$reg->fecha_modificacion,
                "20"=>$reg->usuario_que_activo,
                "21"=>$reg->fecha_activacion,
                "22"=>$reg->usuario_que_desactivo,
                "23"=>$reg->fecha_desactivacion,
                );
        }
